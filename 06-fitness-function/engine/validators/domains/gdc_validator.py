...
class GDCValidator(BaseValidator):
    ...
    def validate_type_specific(self) -> None:
        """Perform Governance Document validations, enforcing meta-governance structures and base architectural tenets."""
        ...
        if self.filename.endswith('-guideline.md'):
            ...
            downstream_subsections = self.global_rules.get('rules', {}).get('structure', {}).get('required_downstream_guideline_subsections', {})
