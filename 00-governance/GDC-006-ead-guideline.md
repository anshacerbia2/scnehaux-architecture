...
> This table is automatically generated from the JSON Schema (`schemas/ead.schema.json`).
...
| **Structural Policies** | Required Sections | <ul><li>Purpose</li><li>Scope</li><li>Enterprise Context</li><li>Architecture Model</li><li>Principles & Rules</li><li>Ownership</li><li>Dependencies</li><li>Traceability</li></ul> |
| **Structural Policies** | Recommended Sections | <ul><li>Risks & Constraints</li><li>Future Direction</li><li>References</li><li>Glossary</li></ul> |
| **Structural Policies** | Required Sections | <ul><li>Vision</li><li>Mission</li><li>Strategic Objectives</li><li>Business Capability Map</li><li>Value Stream</li><li>Operating Model</li><li>Team Topology Principles</li><li>Stakeholder</li></ul> |
| **Structural Policies** | Required Sections | <ul><li>Enterprise Data Principles</li><li>Master Data</li><li>Data Ownership</li><li>Data Classification</li><li>Data Governance</li><li>Data Lifecycle</li><li>Data Flow Landscape</li></ul> |
| **Structural Policies** | Required Sections | <ul><li>Application Portfolio</li><li>Application Interaction</li><li>Application Classification</li><li>Build vs Buy</li><li>Enterprise Integration Strategy</li></ul> |
| **Structural Policies** | Required Sections | <ul><li>Cloud Strategy</li><li>Security Principles</li><li>Observability Principles</li><li>Platform Strategy</li><li>Technology Principles</li><li>Technology Radar</li></ul> |
...
EAD artifacts must remain flat or layered by TOGAF (Business, Data, Application, Tech) within the `01-enterprise/` directory. Domain-Driven Design (DDD) subfolders are strictly prohibited to preserve the holistic enterprise view and prevent domain silos at the C1 level.
...
1. **Markdown Artifacts vs. TOGAF ArchiMate / EA Tools**
