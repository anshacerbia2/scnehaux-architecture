...
| **Structure** | Required Sections | <ul><li>`Context & Business Drivers`</li><li>`Enterprise Principles`</li><li>`Strategic Architecture`</li><li>`Cross-Cutting Standards`</li><li>`Decision Log`</li></ul> |
...
#### 2.3.2 Document Section Semantics
...
#### 2.3.3 Metadata Schema Properties
...
#### 2.3.4 Allowed Lifecycle Statuses
...
#### 2.3.5 Semantic Versioning Classification
