...
> This table is automatically generated from the JSON Schema (`schemas/sad.schema.json`).
...
| **Structural Policies** | Required Sections | <ul><li>Purpose</li><li>Scope</li><li>Solution Context</li><li>Architecture Model</li><li>Data Flow</li><li>Integration Contract</li><li>Security Model</li><li>Deployment Model</li><li>NFR</li><li>Decisions</li><li>Traceability</li></ul> |
| **Structural Policies** | Recommended Sections | <ul><li>Risks</li><li>Migration Strategy</li><li>Operational Considerations</li></ul> |
| **Content Quality Policies** | Context & Scope (Required) | <ul><li>Objective</li><li>Constraint</li><li>Capability</li><li>System Context</li></ul> |
...
| **Content Quality Policies** | Deployment Model (Required) | <ul><li>CI/CD</li><li>Release</li></ul> |
| **Content Quality Policies** | Deployment (Recommended) | <ul><li>Environment</li><li>Infrastructure</li></ul> |
| **Content Quality Policies** | Decisions (Required) | <ul><li>Rejected</li></ul> |
...
**Qualitative Enforcement (Architecture Authority Audit)**
