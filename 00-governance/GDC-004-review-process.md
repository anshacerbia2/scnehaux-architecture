...
1. **Enterprise Alignment (EAD/STD Compliance)**: 
   ...
   - If requesting a standard waiver, is the justification mathematically sound and fully compliant with the Exception criteria defined in GDC-011?
...
3. **Invalid Exception Waivers**: Reference to an Exception ADR that violates the temporal or structural laws established in GDC-011.
