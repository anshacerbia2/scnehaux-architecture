...
The Scnehaux IAM Dashboard is the concrete frontend software application that serves as the administrative interface for the **Enterprise Identity & Access Platform** (defined in [identity-platform.pad.md](../../02-platform/identity-platform/identity-platform.pad.md)). 
