...
# Enterprise React Development Standard (STD-E013)
...
### 2.1 Cohesive Component Locality
...
### 2.4 Casing & File Naming Conventions
...
## 4. Hook Lifecycle Rules

### 4.1 useEffect — Strict Boundary
...
### 4.3 Dependency Array Integrity
...
## 5. Render Optimization (Zero-Waste)

### 5.1 Rendering Optimization & Memoization Modes
...
#### 5.1.1 Legacy Mode (Without React Compiler)
...
#### 5.1.2 Modern Mode (With React Compiler)
...
#### 5.1.3 Mandatory Cases for Manual Memoization under React Compiler
...
#### 5.1.4 Wrapping Uncompiled External Components with `React.memo`
...
#### 5.1.5 Evaluation Metrics for Performance Tuning
...
### 5.3 List Rendering & Key Stability
...
## 6. Component Typings & Props Contracts

### 6.1 Strict TypeScript Contracts
...
### 6.2 Context-Aware Prop Contracts
...
### 6.3 Discriminated Unions for Variant Props
...
## 8. Server Components & Streaming (Future Readiness)
...
## 11. Async Data Consistency & Race-Condition Governance
...
## 12. Performance Profiling & Monitoring
