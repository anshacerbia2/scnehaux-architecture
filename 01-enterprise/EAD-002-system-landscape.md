...
| :-- | :-- | :-- |
| All systems | Identity Platform | Synchronous authN/authZ |
...
| :-- | :-- | :-- |
| Identity Platform (synchronous authN/authZ on every request) | Enterprise-wide | Consumers validate short-lived cached tokens locally during an Identity outage: existing sessions continue read/degraded operation, new logins and writes fail-closed — the estate degrades, it does not stop |
