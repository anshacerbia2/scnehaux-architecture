...
2. **WebSockets (GraphQL Subscriptions / Socket.io)**: Exclusively reserved for high-frequency, bi-directional communication (e.g., chat applications, multiplayer collaborative editing). WebSockets must not be used if the client only needs to *listen* to data.
...
## 7. Compliance Impact
### Related Standards
- [ADR-GLB-FE-008 (GraphQL Protocol)](../../../05-decisions/_global/frontend/ADR-GLB-FE-008-graphql-protocol.md) - Outlines how GraphQL Subscriptions will utilize the WebSocket transport layer.
