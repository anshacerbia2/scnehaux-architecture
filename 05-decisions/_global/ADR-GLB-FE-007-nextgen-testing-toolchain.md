...
- [STD-GLB-FE-008 (Testing)](../../02-standards/_global/STD-GLB-FE-008-testing.md) - This document dictates the normative rules on how the testing toolchain is implemented in CI/CD.
