...
- [STD-GLB-FE-007 (Micro-Frontend)](../../02-standards/_global/STD-GLB-FE-007-micro-frontend.md) - This standard establishes the normative rules and exact threshold conditions for when to adopt Module Federation.
